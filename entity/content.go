...
type Content struct {
	...
	Tags             []Tag               `gorm:"many2many:content_has_tags;ForeignKey:ID;joinForeignKey:ContentID;References:ID;joinReferences:TagID" json:"tags"`
	Topics           []Topic             `gorm:"many2many:content_has_topics;ForeignKey:ID;joinForeignKey:ContentID;References:ID;joinReferences:TopicID" json:"topics"`
	Reporters        []Reporter          `gorm:"many2many:content_has_reporters;ForeignKey:ID;joinForeignKey:ContentID;References:ID;joinReferences:ReporterID" json:"reporters"`
	SubPhotos        []SubPhoto          `gorm:"foreignKey:ContentID" json:"sub_photos"`
